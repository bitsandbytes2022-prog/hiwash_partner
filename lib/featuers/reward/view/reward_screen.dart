                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          (rewardController.offerResponseModel.value?.data?.summary?.totalReward ?? 0) == 1
                              ? StringConstant.kAvailableOffer.tr   // singular
                              : StringConstant.kAvailableOffers.tr, // plural
                          style: w500_12p(
            ...
            Column(
              children: [
                ...
                Obx(() {
                  ...
                  if (rewardController.sortByText.value == StringConstant.kAscendingOrder) {
                    allOffers.sort((a, b) => (a.title ?? '').compareTo(b.title ?? ''));
                  } else if (rewardController.sortByText.value ==
                      StringConstant.kDescendingOrder) {
                    allOffers.sort((a, b) => (b.title ?? '').compareTo(a.title ?? ''));
                  }
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            mainAxisSize: MainAxisSize.min,
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: rewardController.offerFilterList
                                                .asMap()
                                                .entries
                                                .map(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Obx(() {
                                return Text(
                                  rewardController.offerFilterList[
                                  rewardController.selectedFilterIndex.value],
                                  style: w400_12p(color: AppColor.c2C2A2A),
                                );
                              }),
                              Spacer(),
